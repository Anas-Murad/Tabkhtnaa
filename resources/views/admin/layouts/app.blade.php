...
<head>
    ...
    <title>Tabkhtnaa - لوحة التحكم</title>
...
<script>
    ...
    $.extend($.fn.dataTable.defaults, {
        ...
        language: {
            search: '<span class="me-3">بحث:</span> <div class="form-control-feedback form-control-feedback-end flex-fill">_INPUT_<div class="form-control-feedback-icon"><i class="ph-magnifying-glass opacity-50"></i></div></div>',
