...
@section('title') حملات مضاعفة النقاط @endsection
...
function editCampaign(campaign) {
    document.getElementById('editCampaignForm').action = '{{ url('admin/loyalty/campaigns') }}/' + campaign.id;
    document.getElementById('edit_camp_name').value = campaign.name ?? '';
    document.getElementById('edit_camp_start').value = campaign.start_date ?? '';
    document.getElementById('edit_camp_end').value = campaign.end_date ?? '';
    document.getElementById('edit_camp_multiplier').value = campaign.multiplier ?? '';
    document.getElementById('edit_camp_applies').value = campaign.applies_to ?? 'all';
